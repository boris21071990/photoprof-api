describe Api::V1::PhotosController do
  describe "GET /api/v1/photos" do
    ...
    let!(:photo) { create :photo, photographer: photographer, image: fixture_file_upload("profile.png", "image/png") }
    let!(:disabled_photo) { create :photo, photographer: photographer, enabled: false }
